...
class AdConfigService {
  ...
  void _logConfig(AdConfig cfg) {
    ...
    addGroup('inter', cfg.adUnits.inter);
    addGroup('app_open', cfg.adUnits.appOpen);
    addGroup('rewarded', cfg.adUnits.rewarded);
    addGroup('native', cfg.adUnits.native);
    addGroup('banner', cfg.adUnits.banner);
