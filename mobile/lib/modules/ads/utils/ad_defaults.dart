...
/// BẬT/TẮT lấy cấu hình từ Firebase Remote Config.
/// - true: Ưu tiên lấy từ Firebase (Production).
/// - false: Luôn dùng kAdsDevConfig (Local Debug/Test).
const kUseRemoteConfig = false;
